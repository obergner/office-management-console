describe('apiErrorHandler', function () {
    ...
    describe('mapToAlert', function() {

        it('should correctly convert httpResponse with status 400 ApiError to alert of type warning', function () {
            var apiError = {
                status: 400,
        ...
        it('should correctly convert httpResponse with status 501 ApiError to alert of type error', function () {
            var apiError = {
                status: 501,
    ...
    describe('handleApiErrorResponse', function() {
        ...
        it('should correctly convert httpResponse with status 400 ApiError to alert of type warning', function () {
            ...
            apiErrorHandler.dismissAlerts();
            apiErrorHandler.handleApiErrorResponse(httpResponse);
            var alert = apiErrorHandler.alerts[0];
